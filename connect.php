<?php 
      if(!empty($_POST["send"])){
        ...
        $operational = $_POST["operationalCity"];
        $townCity = $_POST["townCity"];
        $btnMessage = $_POST["message"];
        
        $toEmail = "info@centiascleaningservices.co.za";
        
        $mailHeaders ="I am ". $firstName . " " . $lastName
         . "\r\n my email is " . $email
         . "\r\n  my phone number is " . $phoneNo
         . "\r\n Services that i want is " . $services
         . "\r\n i am located at " . $operational .  " in " . $townCity
         . "\r\n " . $btnMessage;
  
        $send_email = mail($toEmail,$firstName,$mailHeaders);
        if ($send_email) {
